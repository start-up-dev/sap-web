...
import { vibeCoderLanding } from "@/content/landing-for-vibe-coders";
...
export const metadata: Metadata = {
  title: vibeCoderLanding.meta.title,
  description: vibeCoderLanding.meta.description,
  keywords: [...vibeCoderLanding.meta.keywords],
};

export default function VibeCoderPage() {
  const c = vibeCoderLanding;
